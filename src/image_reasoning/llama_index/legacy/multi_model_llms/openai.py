...
from src.image_reasoning.llama_index.legacy.bridge.pydantic import Field, PrivateAttr
...
from src.image_reasoning.llama_index.legacy.llms.generic_utils import (
    messages_to_prompt as generic_messages_to_prompt,
)
from src.image_reasoning.llama_index.legacy.llms.openai_utils import (
    from_openai_message,
    resolve_openai_credentials,
    to_openai_message_dicts,
)
from src.image_reasoning.llama_index.legacy.multi_model_llms.openai_utils import (
    GPT4V_MODELS,
    generate_openai_multi_modal_chat_message,
)
from src.image_reasoning.llama_index.legacy.multi_model_llms.base import MultiModalLLM, MultiModalLLMMetadata
