...
from src.image_reasoning.llama_index.legacy.callbacks.base_handler import BaseCallbackHandler
from src.image_reasoning.llama_index.legacy.callbacks.schema import (
    BASE_TRACE_EVENT,
    LEAF_EVENTS,
    CBEventType,
    EventPayload,
